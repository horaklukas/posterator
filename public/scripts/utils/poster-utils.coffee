...
titles = {
  0: [
    {position:{x: 150, y: 170}, text: 'Krkanka', font: {size: 20, family: 'Verdana', color: '000', italic: false, bold: false}}
    {position:{x: 160, y: 400}, text: 'termin', font: {size: 16, family: 'Arial', color: '000', italic: false, bold: false}}
  ]
}
